...
import { getAllCounts, getChartsData,piechartData } from '../Redux/project/Action';
...
const Dashboard = () => {
    ...
    const { fil,pum,gl,wat } = useSelector(store => store.project);
    const dispatch = useDispatch();
    //console.log(total, closed, cancelled, running, closure)
    // -------------------window-size------------------------//

    const [screenSize, setScreenSize] = useState(getCurrentDimension());
    var yAxisLabels = [0,2,4,6,8,10];
    ...
    return (
        <Box display={"flex"} flexDirection={{ sm: "column", md: "row", base: "column", lg: "row", xl: "row" }} gap={{ sm: "0px", base: "0px", md: "2px", lg: "2px", xl: "2px" }} justifyContent={"space-between"}>
            ...
            <Box mb={"80px"}>
                ...
                <Box  width="1400px"   height="500px" display="flex" alignItems="center" justifyContent="center">
                ...
                <Box boxShadow={'rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px'} width={{sm:"96%",md:"96%",base:"96%",lg:"45%",xl:"45%"}} ml={{sm:"0px",base:"0px",md:"20px",lg:"20px",xl:"20px"}}mt={{sm:"0px",base:"0px",md:"40px",lg:"20px",xl:"20px"}} p={{sm:"0px 5px",md:"0px 5px",base:"0px 5px",lg:"0px",xl:"0px"}}>
